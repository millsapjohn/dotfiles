...
<qgis version="3.22.2-Białowieża" styleCategories="Symbology|Labeling|Fields|AttributeTable|CustomProperties" labelsEnabled="0">
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" constraints="0" field="ELEV" notnull_strength="0"/>
  </constraints>
