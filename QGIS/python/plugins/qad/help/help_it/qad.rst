...
Dalla versione 3.0.4 di QAD lo snap ad oggetto verrà eseguito sui layer
abilitati allo snap da QGIS (layer corrente, tutti i layer, solo i layer
selezionati per lo snap).
